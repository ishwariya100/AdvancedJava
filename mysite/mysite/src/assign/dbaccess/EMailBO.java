...
public class EMailBO {
	...
	public void addEMailAddress(EMailAddressVOO inEMailAddressVO) throws EMailValidationException, Exception{
		...
		allMessages.append(errorMsg);
		errorMsg = eMailValidation.validateHomePhone(inEMailAddressVO.gethPhone());
		allMessages.append(errorMsg);
		errorMsg = eMailValidation.validateWorkPhone(inEMailAddressVO.getwPhone());
		allMessages.append(errorMsg);
		errorMsg = eMailValidation.validateMobilePhone(inEMailAddressVO.getmPhone());
		allMessages.append(errorMsg);
		errorMsg = eMailValidation.validateGroupId(inEMailAddressVO.getgroupID());
		allMessages.append(errorMsg);
	...
	public ArrayList<EMailAddressVOO> getAllEMailAddressListbyGroup(String inGroupID) throws EMailValidationException, Exception{
		EMailDBAccess eMailDBAccess = new EMailDBAccess();
		System.out.println("The groupId inside BO is "+inGroupID);
